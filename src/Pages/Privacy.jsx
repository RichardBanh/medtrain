	...
	return (
		<div className='row mx-4 my-5 d-flex justify-content-center'>
			...
			>
				...
				<p>
					<strong>Website</strong> refers to 12154081 Canada Inc..ca, accessible
					from{' '}
					<a href='12154081 Canada Inc..ca' target='_blank'>
						12154081 Canada Inc..ca
					</a>
				</p>
				<p>
				...
				<h1>Emails and Contact</h1>
				<p>
					We use your email address to communicate with you only if you've given
					us permission to do so and only for the reasons you’ve specified. For
					example, if you contact us with a request by email, we respond to you
					via email. You have complete control over how your email address is
					used and shared on 12154081 Canada Inc..
				</p>
				...
				<p>
					...
					the Service or the public Protect against legal liability
				</p>
